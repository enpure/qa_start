        ...
        runScenario(
          ...
          steps: [
            ...
            (
              ...
              return await runStep(
                name: 'И Я указываю отчество "Vyacheslavovich"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
              ...
              return await runStep(
                name: 'И Я указываю дату рождения "1997-10-17"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я выбираю "Art" из интересов',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я перехожу к сохраненному профилю',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
